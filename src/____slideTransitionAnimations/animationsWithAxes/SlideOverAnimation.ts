...
export class SlideOverAnimation extends BaseAnimationWithAxes {
  public readonly withTranslate: IWithTranslateReturnType
  ...
  override resetSlidePositions(): void {
    ...
    this.styles = objectify(
      ...
      slidePosition => {
        ...
        return useAnimatedStyle(() => {
          const style = getAnimatedViewStyle(translate, 'translate')

          // console.log(slidePosition, style)
